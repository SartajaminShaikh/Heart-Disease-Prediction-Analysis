...
Lower maximum heart rate is strongly associated with disease

Reversible thallium defect strongly predicts heart disease
...
Performed exploratory data analysis on medical data
...
Applied predictive analytics in healthcare domain
